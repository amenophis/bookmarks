...
use App\Infrastructure\URIMetadataReader\TestReader;
...
class CreateBookmarkTest extends FunctionalTestCase
{
     ...
     */
    public function testValidationErrors(array $payload, array $errors): void
    {
    ...
    public function provideValidationErrors(): \Generator
    {
        yield [
            [],
            [
    ...
    /**
     * @dataProvider provideSuccessfulResponse
     */
    public function testSuccessfulCreation(array $payload, array $responsePattern, URIMetadata $metadata): void
    {
    ...
    public function provideSuccessfulResponse(): \Generator
    {
        yield [
            [
